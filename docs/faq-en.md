...
1. Ask YDGPT / Bing / Baidu / Google, etc.
...
- Select your YDGPT-next-web project;
...
2. When deploying the project, set the environment variable CODE (supports multiple passwords, separated by commas). After setting the access password, users need to enter the access password in the settings page to use it. See [related instructions](https://kdocs.cn/l/clqy73OQZ4C5#access-password)

## Why doesn't the version I deployed have streaming response
> Related discussion: [#386](https://kdocs.cn/l/clqy73OQZ4C5/issues/386)
...
## Why does YDGPT's reply get garbled
...
- Chinese policy restricts proxy access to foreign websites/YDGPT-related applications, which may be blocked.
...
Please refer to: [#371](https://kdocs.cn/l/clqy73OQZ4C5/issues/371)

## Why is my Token consumed so fast?
> Related discussion: [#518](https://kdocs.cn/l/clqy73OQZ4C5/issues/518)
